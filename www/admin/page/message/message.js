...
layui.config({
    ...
    $.get("http://www.linzantian.com/admin/message/read",function(r){
        ...
        for(var i=0; i<data.length; i++){
            ...
            msgHtml += '    <img src="'+data[i].userface+'" width="50" height="50"><input type="hidden" value="'+data[i].id+'">';
                        ...
                        if(data[i].id == ids){
                            if(data[i].msgReply && data[i].msgReply.length != 0){
                                for(var j=0;j<data[i].msgReply.length;j++){
                                    ...
                                    msgReplyHtml += '        <h2>'+data[i].msgReply[j].userName+' 回复：</h2>';
                            ...
                            msgReplyHtml += '    <div class="user_info">';
                            msgReplyHtml += '        <h2 data-id='+ids+' class="rId">'+data[i].userName+'</h2>';
    ...
    $(".send_msg").click(function(){
        if(layedit.getContent(editIndex) != ''){
            ...
            $.post('http://www.linzantian.com/admin/message/reply',data,function(r){
                if(r.res=='0000'){
